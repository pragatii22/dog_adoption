...
def application_form1():

    
    form = Toplevel()
    form.title("📝 Dog Adoption Application Form")
    form.geometry("870x700")
    form.configure(bg="#E8F4FD")  # Light blue background instead of skyblue
    ...
    main_container = Frame(form, bg="#E8F4FD")  # Match root background
